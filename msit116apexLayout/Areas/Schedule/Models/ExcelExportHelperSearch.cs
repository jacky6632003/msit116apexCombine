...
namespace msit116apexLayout.Areas.Schedule.Models
{
    public class ExcelExportHelperSearch
    {
            ...
            using (ExcelPackage package = new ExcelPackage())
            {
                ...
                foreach (DataColumn item in dataTable.Columns)
                {
                    ...
                    if (maxLength < 150)
                    {
                        ...
                        {//若為日期自訂儲存格顯示格式
                            workSheet.Column(columnIndex).Style.Numberformat.Format = "yyyy/MM/dd HH:mm";
                        }
                ...
                //取得做法可參考最後的參考連結。
                workSheet.Cells[1, col++].Value = "假單號碼";
                workSheet.Cells[1, col++].Value = "員工姓名";
                workSheet.Cells[1, col++].Value = "開始時間";
                workSheet.Cells[1, col++].Value = "結束時間";

                workSheet.Cells[1, col++].Value = "假別";
                workSheet.Cells[1, col++].Value = "代理人";
                workSheet.Cells[1, col++].Value = "內容";
                workSheet.Cells[1, col++].Value = "部門";

                workSheet.Cells[1, col++].Value = "審查狀態";
