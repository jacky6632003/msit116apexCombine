    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "1132631993533479",
               appSecret: "6105e39593809ddb86530021d94784bf");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "602571447668-n61s2n4t2oujj1hg5kotm5ru0v7ncqhj.apps.googleusercontent.com",
                ClientSecret = "zmpTQZNYRYMQ4k2o3zqWqjaY"
            });
        }
    }
}